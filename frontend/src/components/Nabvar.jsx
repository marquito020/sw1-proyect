              ...
              <div className="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
                ...
                <div className="hidden sm:ml-6 sm:block">
                  <div className="flex space-x-4">
                    <button
                      onClick={() => alert("Función de generación con IA próximamente")}
                      className="flex items-center mb-1 gap-4 py-2 px-4 border-b-2 border-indigo-400 hover:bg-indigo-100 transition-colors"
                    >
                      Generar con IA
                    </button>
                    {user.rol === "Narrador"
